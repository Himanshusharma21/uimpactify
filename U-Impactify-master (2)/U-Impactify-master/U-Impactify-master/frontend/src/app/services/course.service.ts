...
export class CourseService {
  ...
  postNewCourse(course: any, _id: string): Observable<Course> {
    ...
    return this.http.post<Course>(`${this.baseUrl}/api/course/`, {
      name,
      students: [],
      teachers: [_id],
      description,
  ...
  updateCourse(course: any): Observable<Course> {
    return this.http.put<Course>(`${this.baseUrl}/api/course/update`, {
      course,
    });
  }
  ...
  postNewFile(file: FormData, courseId: string) {
    return this.http.post(`${this.baseUrl}/api/course/${courseId}/upload`, file);
  }
  ...
  postNewAssessmentFile(file: FormData, assessmentId: string) {
    return this.http.post(
      `${this.baseUrl}/api/course/assessment/uploadAssessment/${assessmentId}`,
      file
    );
  }
  ...
  requestSurvey(id: string): Observable<Course> {
    return this.http.put<Course>(`${this.baseUrl}/api/course/surveyRequest/${id}`, {});
  }
  ...
  getCourseFiles(courseId: string): Observable<any> {
    return this.http.get(`${this.baseUrl}/api/document/${courseId}`);
  }
  ...
  search(query: string): Observable<Course[]> {
    return this.http.get<Course[]>(`${this.baseUrl}/api/course/search/${query}`);
  }
  ...
  getCourseImageId(courseId: string): Observable<any> {
    return this.http.get(`${this.baseUrl}/api/course/${courseId}/getCourseImage`);
  }
  ...
  postCourseImage(file: FormData, courseId: string): Observable<Course> {
    return this.http.post<Course>(
      `${this.baseUrl}/api/course/${courseId}/uploadCourseImage`,
      file
    );
  }
  ...
  getCourse(_id: string): Observable<Course> {
    return this.http.get<Course>(`${this.baseUrl}/api/course/${_id}`);
  }
  ...
  enrollInCourse(userId: string, courseId: string): Observable<any> {
    return this.http.put(`${this.baseUrl}/api/course/enroll`, {
      userId,
      courseId,
    });
  }
  ...
  dropACourse(userId: string, courseId: string): Observable<any> {
    return this.http.delete(`${this.baseUrl}/api/course/dropCourse/${courseId}/${userId}`);
  }
  ...
  addAReview(
    ...
    return this.http.put<Course>(`${this.baseUrl}/api/course/addReview`, {
      _id,
      courseId,
      courseReview,
      score,
  ...
  postNewAssessment(assessment: any): Observable<Assessment> {
    ...
    return this.http.post<Assessment>(`${this.baseUrl}/api/course/assessment`, {
      name,
      files: [],
      visibility,
      studentSubmission,
  ...
  postAssessmentCourse(
    ...
    return this.http.put<Course>(`${this.baseUrl}/api/course/assessment/addAssessment`, {
      courseId,
      assessmentId,
    });
  }
  ...
  deleteAssessment(courseId: string, assessmentId: string): Observable<any> {
    return this.http.delete(
      `${this.baseUrl}/api/course/assessment/deleteAssessment/${courseId}/${assessmentId}`
    );
  }
  ...
  deleteFiles(assessmentId: string): Observable<any> {
    return this.http.delete(
      `${this.baseUrl}/api/course/assessment/deleteFiles/${assessmentId}`
    );
  }
  ...
  updateAssessment(
    ...
    return this.http.put<Assessment>(
      `${this.baseUrl}/api/course/assessment/updateAssessment/${assessmentId}/${name}/${visibility}`,
      files
    );
  }
  ...
  deleteStudentSubmission(assessmentId: string, studentId: string) {
    return this.http.delete(
      `${this.baseUrl}/api/course/assessment/deleteStudentSubmission/${assessmentId}/${studentId}`
    );
  }
  ...
  postStudentSubmission(
    ...
    return this.http.put<Assessment>(
      `${this.baseUrl}/api/course/assessment/addStudentSubmission/${assessmentId}/${studentId}`,
      files
    );
  }
  ...
  getAssessment(assessmentId: string): Observable<Assessment> {
    return this.http.get<Assessment>(
      `${this.baseUrl}/api/course/assessment/getAssessment/${assessmentId}`
    );
  }
  ...
  getAllAssessments(courseId: string): Observable<Assessment[]> {
    return this.http.get<Assessment[]>(
      `${this.baseUrl}/api/course/assessment/getAllAssessments/${courseId}`
    );
  }
  ...
  getAllStudentSubmissions(assessmentId: string): Observable<Object[]> {
    return this.http.get<Object[]>(`${this.baseUrl}/api/course/assessment/${assessmentId}`);
  }
  ...
  getStudentSubmission(
    ...
    return this.http.get<String[]>(
      `${this.baseUrl}/api/course/assessment/${courseId}/${assessmentId}/${studentId}`
    );
  }
  ...
  addSurvey(
    ...
    return this.http.put<Course>(`${this.baseUrl}/api/course/addSurvey`, {
      _id,
      courseId,
      surveyAnswers,
    });
  ...
  postUploadLecture(video: FormData, courseId: string) {
    return this.http.post(`${this.baseUrl}/api/course/${courseId}/uploadLecture`, video);
  }
  ...
  updateMark(
    ...
    return this.http.put<any>(`${this.baseUrl}/api/course/assessment/updateMark`, {
      assessmentId,
      studentId,
      mark,
    });
  ...
  bulkUpdateCourseImage(_id: string, img: string): Observable<Course> {
    return this.http.put<Course>(`${this.baseUrl}/api/course/bulkUpdateCourseImage`, {
      _id, img
    })
  }
}