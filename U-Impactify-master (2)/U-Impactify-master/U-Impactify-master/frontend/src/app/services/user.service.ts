...
export class UserService {
  ...
  postNewUser(newUser: User): Observable<User> {
    ...
    return this.http.post<User>(`${this.baseUrl}/api/user`, {
      _id,
      password,
      email,
      type,
  ...
  putQuestionaire(user: User): Observable<any> {
    ...
    return this.http.put(`${this.baseUrl}/api/user/addQuestionaire/`, {
      _id,
      questionaire,
    });
  }
  ...
  search(query: String): Observable<User[]> {
    return this.http.get<User[]>(`${this.baseUrl}/api/user/search/${query}`);
  }
  ...
  loginUser(email: string, password: string): Observable<User | boolean> {
    return this.http.post<User | boolean>(`${this.baseUrl}/api/user/${email}`, {
      password,
    });
  }
  ...
  enrollInCourse(userId: string, course: any): Observable<any> {
    return this.http.put(`${this.baseUrl}/api/user/enroll/`, {
      userId,
      course,
    });
  }
  ...
  updatePassword(_id: string, password: string): Observable<any> {
    return this.http.post(`${this.baseUrl}/api/user/updatePassword`, {
      _id,
      password,
    });
  }
  ...
  updateClassesTeaching(_id: string, course: any): Observable<any> {
    return this.http.put(`${this.baseUrl}/api/user/updateClassesTeaching`, {
      _id,
      course,
    });
  }
  ...
  updateCredit(_id: string, credit: number): Observable<any> {
    return this.http.put(`${this.baseUrl}/api/user/updateCredit`, {
      _id,
      credit, 
    });
  }
  ...
  dropACourse(userId: string, courseId: string): Observable<any> {
    return this.http.delete(`${this.baseUrl}/api/user/dropCourse/${courseId}/${userId}`);
  }
  ...
  deleteUser(userId: string): Observable<any> {
    console.log(userId);
    return this.http.delete(`${this.baseUrl}/api/user/deleteUser/${userId}`);
  }
  ...
  addSocialInitiativeProfile(
    ...
    return this.http.put<User>(`${this.baseUrl}/api/user/addSocialInitiativeProfile`, {
      registeredNumber,
      businessNumber,
      location,
      hours,
  ...
  updateProfile(_id: string, profile: any): Observable<User> {
    return this.http.put<User>(`${this.baseUrl}/api/user/addProfile`, {
      _id,
      profile,
    });
  }
  ...
  getAllSI(): Observable<any> {
    return this.http.get(`${this.baseUrl}/api/user/getAllSI`);
  }

  addChat(userId: string, chatId: string): Observable<User> {
    return this.http.put<User>(`${this.baseUrl}/api/user/addChat`, {
      userId,
      chatId,
    });
  }
  ...
  getUserImage(userId: string): Observable<any> {
    return this.http.get(`${this.baseUrl}/api/user/${userId}/getUserImage`);
  }
  ...
  postUserImage(file: FormData, userId: string): Observable<User> {
    return this.http.post<User>(`${this.baseUrl}/api/user/${userId}/uploadUserImage`, file);
  }
  ...
  createNewOpportunity(opportunity: Opportunity): Observable<any> {
    ...
    return this.http.put(`${this.baseUrl}/api/user/opportunity`, {
      recruiter,
      name,
      description,
      type,
  ...
  addNewVolunteerOpportunity(userId: string, opportunityId: string) {
    return this.http.put(`${this.baseUrl}/api/user/addVolunteerOpportunity`, {
      userId,
      opportunityId,
    });
  }
  ...
  addNewEmploymentOpportunity(userId: string, opportunityId: string): Observable<User> {
    return this.http.put<User>(`${this.baseUrl}/api/user/addEmploymentOpportunity`, {
      userId,
      opportunityId,
    });
  }
  ...
  getVolunteerOpportunity(): Observable<any> {
    return this.http.get<Opportunity[]>(
      `${this.baseUrl}/api/user/opportunity/getVolunteerOpportunities`
    );
  }
  ...
  getEmploymentOpportunity(): Observable<any> {
    return this.http.get<Opportunity[]>(
      `${this.baseUrl}/api/user/opportunity/getEmploymentOpportunities/`
    );
  }
  ...
  applyOpportunity(
    ...
    return this.http.put(`${this.baseUrl}/api/user/opportunity/applyOpportunity`, {
      opportunityId,
      applicantUserId,
    });
  }
  ...
  deleteOpportunity(opportunityId: any): Observable<any> {
    return this.http.delete(
      `${this.baseUrl}/api/user/opportunity/deleteOpportunity/${opportunityId}`
    );
  }
  ...
  removeOpportunity(_id: string, opportunityId: any): Observable<User> {
    return this.http.delete<User>(
      `${this.baseUrl}/api/user/opportunity/removeOpportunity/${_id}/${opportunityId}`
    );
  }
  ...
  updateOpportunity(opportunity: Opportunity): Observable<Opportunity> {
    return this.http.put<Opportunity>(
      `${this.baseUrl}/api/user/opportunity/updateOpportunity`,
      { opportunity }
    );
  }
}
